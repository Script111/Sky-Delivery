...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
        ...
        log.info("【模拟支付】跳过微信支付接口，订单号：{}", ordersPaymentDTO.getOrderNumber());
    ...
    @Override
    public PageResult getHistoryPage(Integer pageNum, Integer pageSize, Integer status) {
        OrdersPageQueryDTO ordersPageQueryDTO = new OrdersPageQueryDTO();
        ordersPageQueryDTO.setStatus(status);
        ordersPageQueryDTO.setUserId(BaseContext.getCurrentId());

        PageHelper.startPage(pageNum, pageSize);
        Page<Orders> pageResult = orderMapper.getPage(ordersPageQueryDTO);
    ...
    public void remind(Long id) {
        ...
        if(ordersDB.getStatus().equals(Orders.TO_BE_CONFIRMED) && ordersDB.getPayStatus().equals(Orders.PAID)) {
